...
urlpatterns=[
    path('', views.Car_List.as_view(), name='home'), # name = nameof the route
    ...
    path('user/<username>/cars/<int:pk>/', views.Car_Detail.as_view(), name='car_detail'),

    path('features/', views.Car_Features_Index, name='features_index'),
    path('features/<int:car_features_id>', views.Car_Features_Show, name="car_features_show"),
